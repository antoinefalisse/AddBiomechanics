...
if dataset == 'cmu_dataset':
    ...
    marker_set_fixed = ['RACR', 'LACR', 'C7', 'CLAV', 'RLEL', 'RFAradius', 'RFAulna',
                     'LLEL', 'LFAradius', 'LFAulna', 'RASI', 'LASI', 'RPSI', 'LPSI', 'RLFC', 'RLMAL', 
                    'RCAL', 'RTOE', 'RMT5','LLFC','LLMAL','LCAL', 'LTOE', 'LMT5']
      
    subjects = ['subject01', 'subject02', 'subject03', 'subject04', 'subject08', 
                'subject10', 'subject11', 'subject17', 'subject19', 'subject20']
