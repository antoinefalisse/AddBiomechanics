...
sshpass -p 'Stanford!' scp -r C:/Users/antoi/Documents/MyRepositories/AddBiomechanics/server/data/$dataset/* "clarkadmin@171.65.102.146:Documents/MyRepositories_Antoine/AddBiomechanics/server/data/$dataset/"