...
for n in s1_acting1 #subject02 subject03 subject04 subject08 subject10 subject11 subject17 subject19 subject20;
# for n in Subject1
do
    mkdir -p "/mnt/c/Users/antoi/Documents/MyRepositories/AddBiomechanics/server/data/totalcapture_2/$n/osim_results"
    sshpass -p 'Stanford!1' scp -r clarkadmin@171.65.102.45:Documents/MyRepositories_Antoine/AddBiomechanics/server/data/${dataset}/$n/osim_results/* "/mnt/c/Users/antoi/Documents/MyRepositories/AddBiomechanics/server/data/totalcapture_2/$n/osim_results"
done;
